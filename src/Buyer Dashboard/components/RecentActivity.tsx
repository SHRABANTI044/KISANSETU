...
import { BUYER_ACTIVITIES } from "../data/buyerDashboardData";
  ...
  return (
    <section className="flex flex-col rounded-2xl border border-[#E1E5E1] bg-white p-5 shadow-[0_10px_30px_-18px_rgba(17,17,17,0.12)] sm:p-6">
      ...
      <ul className="mt-5 flex flex-col">
        {BUYER_ACTIVITIES.map((activity) => (
          <li key={activity.id} className="flex items-start gap-3 border-b border-[#F0F3F0] py-3 last:border-0 last:pb-0">
